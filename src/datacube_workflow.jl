...
@time tx_fit, vx_fit, ampx_fit, phasex_fit, vx_fit_err, ampx_fit_err, fitx_count, fitx_outlier_frac, outlier[i][valid] = ITS_LIVE.lsqfit(C[i,"vx"][valid],C[i,"vx_error"][valid],C[i,"mid_date"][valid],C[i,"date_dt"][valid]);
